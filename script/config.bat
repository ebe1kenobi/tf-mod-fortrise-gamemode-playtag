...
set BUILD_NAME=TFModFortRiseGameModePlaytag
...
set REPO_PATH=D:\__dev\code\FR5tf-mod-fortrise-gamemode-playtag\
set REPO_BUILD_PATH=%REPO_PATH%VSCode\bin\Debug\net10.0\
set REPO_RELEASE_PATH=%REPO_PATH%release\
set REPO_RELEASE_MOD_PATH=%REPO_RELEASE_PATH%\tf-mod-fortrise-gamemode-playtag\
