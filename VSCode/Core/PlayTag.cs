...
{
  public class PlayTagPickup : Pickup, IRegisterable
  {
    ...
    public static IPickupEntry PlayTagMeta = null!;
    ...
    public PlayTagPickup(Vector2 position, Vector2 targetPosition)
